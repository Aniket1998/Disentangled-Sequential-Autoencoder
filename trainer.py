...
vae = DisentangledVAE(f_dim=256, z_dim=32, step=256, factorised=False)
trainer = Trainer(vae, sprite, sprite_test, loader ,None, batch_size=32, epochs=500, learning_rate=0.0002, device=torch.device('cuda:1'))
