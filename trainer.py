...
vae = DisentangledVAE(f_dim=64, z_dim=32, step=256, factorised=True,device=device)
test_f = torch.rand(1,64, device=device)
test_f = test_f.unsqueeze(1).expand(1, 8, 64)
